...
# TODO: use a list comprehension to create a list of only the numbers that are greater than 9 from the numbers (not
#  strings) you just created
num_list = [number for number in numbers if number > 9]
print(num_list)
